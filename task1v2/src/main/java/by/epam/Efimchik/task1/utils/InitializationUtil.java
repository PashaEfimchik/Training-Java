...
public class InitializationUtil {
    ...
    public void uploadProducts(List<Product> listProduct) {
        listProduct.add(new Product(11, "auto1.by", "Air filter", "MANN-FILTER C 2245", 30));
        listProduct.add(new Product(12, "armtek", "Catalyst", "ASSO 04.0019", 399));
        listProduct.add(new Product(21, "autoostrov.by", "Clutch kit", "STELLOX 07-01055-SX", 115));
        listProduct.add(new Product(33, "pitavto.by", "Battery", "BOSCH MOBA FP M4F 12V 18 AH 200A R+", 170));
        listProduct.add(new Product(52, "mg.by", "Motor oil", "Motul 7100 4T 10W-40 4L", 154));
    }
}
